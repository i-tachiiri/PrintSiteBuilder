...
{
    public class 一桁の足し算_繰り上がり無 : IPrint
    {
        private List<int> answerIndex = new List<int> { 4, 10 };
        public int PagesCount { get; private set; }
        private int Score = 10;
        private string PrintName = "一桁の足し算(繰り上がり無)";
        public string PresentationId { get; private set; }
        public 一桁の足し算_繰り上がり無()
        {
            PresentationId = "1yjquYyEBE_VgTpAMZ5mzw61r2oWnqQ0rteXFckBXnAw";
            PagesCount = 100;
        }
